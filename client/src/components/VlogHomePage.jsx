...
const opts = {
  ...
  class VlogHomePage extends React.Component { 
    ...
    <img className="card-image2" alt={this.props.video.snippet.title} src={this.props.video.snippet.thumbnails.high.url}/>
    <img className="card-secondImage" alt='Play Sign' src={this.state.hovering ? "https://i.ibb.co/hChgLkq/yt-icon-rgb.png" : 'https://i.ibb.co/47cKNLk/youtube-social-icon-dark.png'} />
    </div>
