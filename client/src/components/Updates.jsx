...
class Updates extends React.Component { 
  ...
  render () {
    ...
    //         <meta property="og:image" content={this.state.blog.blogImage} /> */}
            <meta property="og:image" content='https://vip.vantageproduction2.com/Share/Content/5062427/top-image-092319.jpg' />
   ...
   height="1500px"
   src='https://vip.vantageproduction2.com/HtmlTemplate/5064192/7c6db342-673c-40ba-bdf3-8b74cf94ac9d/Render?ver=3&partnerid=0'>  
     </iframe>
     <BottomNav/>
   </MuiThemeProvider>
)
