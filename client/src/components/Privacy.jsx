...
class Privacy extends React.Component { 
  ...
  render () {
    return (
      <MuiThemeProvider>
        <LeadingBar/>
        <div style={{paddingTop:'10%', marginLeft:'10%', marginRight:'10%'}}>
<h3>
Privacy Policy
</h3>
  <h3>
...
<p>
At Benchmark, we want you to be comfortable and confident when using our Web site. Therefore, we would like to share with you the following principles that govern our information practices and other privacy aspects of our Web site:
</p>
<h3>
We Provide You Notice of our Website Information Practices
</h3>
<p>
To maximize the value of our services, we may request information from you when you visit our Web sites. Benchmark does not share your personal information with outside companies for their promotional use.
</p>
<p>
...
Your personally identifiable information may be transferred in connection with a sale, merger, transfer, exchange or other disposition (whether of assets, stock or otherwise) of all or a portion of a business of Benchmark. You will have the opportunity to opt out of further secondary use of your information following any change of control.
<h3>
•Changes to Our Privacy Policy
</h3>
If we plan to make significant changes to any of our privacy policies or practices with respect to how we use personally identifiable information, we’ll post those changes to the Benchmark Website 30 days before they take effect.
<h3>
•Legal Disclosures
</h3>
